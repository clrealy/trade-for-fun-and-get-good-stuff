...
(function (root, factory) {
  ...
  const ITEMS = [
    ...
    I('t_blood3', 'knife', "Reaper's Scythe", 'Godly', '#2b2b2b', 1, { exclusive: true, trophy: true }),
    I('t_blood4', 'knife', 'Death Itself', 'Chroma', 'chroma', 1, { exclusive: true, trophy: true, noCooldown: true }),
    I('t_play1', 'gun', 'Rookie Revolver', 'Uncommon', '#a0a4ad', 1, { exclusive: true, trophy: true }),
    I('t_play2', 'gun', 'Regular Blaster', 'Rare', '#6c8cff', 1, { exclusive: true, trophy: true }),
    I('t_play3', 'knife', 'No Life Blade', 'Ancient', '#7fff00', 1, { exclusive: true, trophy: true }),
    I('t_win1', 'gun', 'Bronze Revolver', 'Rare', '#cd7f32', 1, { exclusive: true, trophy: true }),
    I('t_win2', 'gun', "Champion's Luger", 'Godly', '#ffd700', 1, { exclusive: true, trophy: true }),
    I('t_murd', 'knife', 'Murderer Main', 'Godly', '#ff4d5e', 1, { exclusive: true, trophy: true }),
    I('t_sher', 'gun', 'Law & Order', 'Godly', '#4da3ff', 1, { exclusive: true, trophy: true }),
    I('t_hero1', 'gun', 'Hero Pistol', 'Uncommon', '#ffc233', 1, { exclusive: true, trophy: true }),
    I('t_hero2', 'gun', 'Hero Blaster', 'Legendary', '#ffc233', 1, { exclusive: true, trophy: true }),
    I('t_duel1', 'knife', 'Duelist Saber', 'Legendary', '#c0c8ff', 1, { exclusive: true, trophy: true }),
    I('t_duel2', 'gun', 'Duel King Scope', 'Ancient', '#ffd700', 1, { exclusive: true, trophy: true, long: true }),
    I('t_surv', 'knife', "Survivor's Machete", 'Rare', '#5f8a3a', 1, { exclusive: true, trophy: true }),
    I('t_coin1', 'gun', 'Coin Flipper', 'Rare', '#ffd43b', 1, { exclusive: true, trophy: true }),
    I('t_coin2', 'gun', 'Money Gun', 'Legendary', '#2fb344', 1, { exclusive: true, trophy: true }),
    I('t_box1', 'knife', 'Box Cutter', 'Uncommon', '#ff9f1c', 1, { exclusive: true, trophy: true }),
    I('t_box2', 'gun', 'Jackpot Blaster', 'Godly', '#e35bff', 1, { exclusive: true, trophy: true }),
    I('t_trade', 'knife', 'Handshake', 'Rare', '#f7d154', 1, { exclusive: true, trophy: true }),
    I('t_lvl1', 'knife', 'Star Blade', 'Legendary', '#fff4a8', 1, { exclusive: true, trophy: true }),
